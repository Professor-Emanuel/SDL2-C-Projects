...
NOT WORKING yet, no code errors, but player is not rendered anymore after encapsulating everything in the GameObject class.
...
Tilemaps rendering works properly, the player & enemy are rendering now but not really properly, instead they appear as 2 white squares.
